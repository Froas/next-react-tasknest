...
const GoalHeaderCard: React.FC<GoalHeaderCardProps> = ({ goal, progress }) => {
 ...
 {/* Background gradient */}
 <div className="absolute inset-0 bg-card dark:bg-card"></div>
 ...
 <div className="relative bg-card/90 dark:bg-card/90 backdrop-blur-sm rounded-2xl mb-8 border border-border dark:border-border overflow-hidden">
 ...
 className="text-foreground dark:text-muted-foreground/60 text-lg leading-relaxed max-w-4xl"
 />
 )}
 </div>
 ...
 <span className="text-foreground dark:text-muted-foreground/60 font-medium">Overall Progress</span>
 <span className="text-2xl font-bold text-foreground">{Math.max(0, Math.round(progress))}%</span>
 </div>
 
 {/* Progress bar */}
 <div className="relative">
 <div className="bg-muted dark:bg-card rounded-full h-3 overflow-hidden">
 <div
 ...
 {/* Priority badge */}
 <div className={`px-4 py-2 rounded-full text-sm font-medium border ${priorityStyles[goal.priority as PriorityType] || 'bg-muted dark:bg-card text-foreground dark:text-muted-foreground/60 border-border dark:border-border'}`}>
 <div className="flex items-center space-x-2">
