  ...
  return (
    <div className="relative py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Track your progress through each milestone</p>
      </div>
          ...
          {milestones.map((milestone, idx) => (
            <div key={milestone.id} className="relative flex items-start group">
              ...
              <div className="relative z-10 flex-shrink-0">
                ...
                <div className="absolute top-3 left-6 w-8 h-0.5 bg-gray-200 group-hover:bg-gray-300 transition-colors duration-300" />
              </div>
              ...
              <div className="absolute -left-2 -top-2 w-6 h-6 bg-gray-900 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg">
                {idx + 1}
              </div>
            </div>
          ))}
