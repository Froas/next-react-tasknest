      ...
      <main className="container mx-auto px-6 py-8">
        ...
        {sortedGoals.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">Create your first goal to start building your roadmap</p>
            <button
              onClick={() => setIsCreatingGoal(true)}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {sortedGoals.map((goal) => (
              <div key={goal.id} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow">
